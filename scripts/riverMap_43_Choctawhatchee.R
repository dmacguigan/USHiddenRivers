...
HUCs <- c("031402") # top-level vector of HUCs to match (must be strings, not numeric)
# search for HUCs here: https://water.usgs.gov/wsc/map_index.html
river_name <- "Choctawhatchee" # river name for files
river_name_plot <- "Choctawhatchee" # river name for plot title
...
cities_subset[1,] <- c("AL", "Dothan", 31.2232, -85.3905)
