...
HUCs <- c("0304") # top-level vector of HUCs to match (must be strings, not numeric)
# search for HUCs here: https://water.usgs.gov/wsc/map_index.html
river_name <- "PeeDee" # river name for files
river_name_plot <- "Pee Dee" # river name for plot title
