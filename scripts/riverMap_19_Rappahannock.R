...
HUCs <- c("02080103", "02080104") # top-level vector of HUCs to match (must be strings, not numeric)
# search for HUCs here: https://water.usgs.gov/wsc/map_index.html
river_name <- "Rappahannock" # river name for files
river_name_plot <- "Rappahannock" # river name for plot title
...
#inlet_sf_crop <- st_crop(inlet_sf, xmin = xmin, xmax = max,
#                         ymin = ymin, ymax = ymax) 
