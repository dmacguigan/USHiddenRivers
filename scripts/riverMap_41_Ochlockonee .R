...
HUCs <- c("03120003", "03120002") # top-level vector of HUCs to match (must be strings, not numeric)
# search for HUCs here: https://water.usgs.gov/wsc/map_index.html
river_name <- "Ochlockonee" # river name for files
river_name_plot <- "Ochlockonee" # river name for plot title
...
cities_subset[1,] <- c("FL", "Tallahassee", 30.4383, -84.2807)
