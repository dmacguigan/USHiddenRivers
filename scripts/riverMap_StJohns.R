...
p <- ggplot() +
  ...
  annotation_scale(location = "bl", width_hint = 0.2, unit_category="imperial") + # adjust scale location as needed
  annotation_scale(location = "tr", width_hint = 0.2, unit_category="metric") + # adjust scale location as needed
