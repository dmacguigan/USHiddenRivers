...
cities_subset[1,] <- c("Maine", "Bangor", 44.8016, -68.7712)
...
p <- ggplot() +
  ...
  annotate("text", x=-70.53, y=45.8, label="Quebec", color="white", hjust=0.5, vjust=0.5, size=5, angle=50) +
  annotate("text", x=-67.7, y=46.2, label="New Brunswick", color="white", hjust=0.5, vjust=0.5, size=5, angle=-90) +
