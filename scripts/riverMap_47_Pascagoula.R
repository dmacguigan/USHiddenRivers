...
HUCs <- c("03170001","03170002","03170003","03170004","03170005","03170006","03170007","03170008") # top-level vector of HUCs to match (must be strings, not numeric)
# search for HUCs here: https://water.usgs.gov/wsc/map_index.html
river_name <- "Pascagoula" # river name for files
river_name_plot <- "Pascagoula" # river name for plot title
